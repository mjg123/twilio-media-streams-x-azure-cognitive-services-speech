...
public class AzureSTTService {
    ...
    public AzureSTTService(Consumer<String> transcriptionHandler) {

        System.out.println(SPEECH_SUBSCRIPTION_KEY);
        ...
        speechRecognizer.sessionStarted.addEventListener((o, sessionEventArgs) ->
            System.out.println("sessionStarted " + sessionEventArgs));

        speechRecognizer.speechStartDetected.addEventListener((o, sessionEventArgs) ->
            System.out.println("speechStartDetected " + sessionEventArgs));
